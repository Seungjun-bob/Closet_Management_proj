...
class UploadImage(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            path_hubconfig = "C:/Users/crid2/django_yolo_web/yolov5_code"
            path_weightfile = "C:/Users/crid2/django_yolo_web/yolov5_code/train_file/yolov5s.pt"  # or any custom trained model
